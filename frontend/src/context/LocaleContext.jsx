...
const translations = {
  tr: {
    ...
    'admin.ssl': 'SSL',
    'admin.valid': 'Geçerli',
    'admin.newWorkspace': 'Yeni Çalışma Alanı',
    'admin.newWorkspaceDesc': 'Yeni müşteri çalışma alanı oluştur',
    'admin.addUser': 'Kullanıcı Ekle',
    'admin.addUserDesc': 'Yeni kullanıcı veya admin oluştur',
    'admin.publishUpdateDesc': 'Tüm çalışma alanlarına anlık güncelleme',
    'admin.usersPerWorkspace': 'Çalışma Alanı Başına Kullanıcı',
    ...
    'admin.confirmDeleteUpdate': 'Bu güncellemeyi silmek istediğinizden emin misiniz?',
    'admin.updateDeleted': 'Güncelleme silindi',
    ...
    'admin.workspaceUpdate': 'Çalışma Alanı Güncelleme',
    'admin.selectWorkspaces': 'Çalışma Alanı Seç',
  ...
  en: {
    ...
    'admin.confirmDeleteUpdate': 'Are you sure you want to delete this update?',
    'admin.updateDeleted': 'Update deleted',
