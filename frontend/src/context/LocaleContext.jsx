...
const translations = {
  tr: {
    ...
    'download.verified': 'Paket Doğrulandı',
    'download.instructions': 'ZIP dosyasını açın ve BaridaRecipeManager.exe dosyasını çalıştırın.',
    'download.appDescription': 'Endüstriyel Reçete Yönetim Sistemi',
    'download.signed': 'Portatif',
  ...
  en: {
    ...
    'download.verified': 'Package Verified',
    'download.instructions': 'Extract the ZIP file and run BaridaRecipeManager.exe to start.',
